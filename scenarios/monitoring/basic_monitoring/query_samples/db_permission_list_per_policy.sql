...
select 
  t4.id as policy_id, t4.name as policy_name, t4.description as policy_description, t4.operation database_operation, d.id as database_id, d.name as database_name
from temp4 t4
