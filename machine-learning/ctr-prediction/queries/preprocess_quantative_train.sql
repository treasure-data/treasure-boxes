...
quantative as (
  ...
  union all
  select rowid, 16777217 + 3 as feature, i3 as value from train_nonzero
  union all
  select rowid, 16777217 + 4 as feature, i4 as value from train_nonzero
  union all
  select rowid, 16777217 + 5 as feature, i5 as value from train_nonzero
  union all
  select rowid, 16777217 + 6 as feature, i6 as value from train_nonzero
  union all
  select rowid, 16777217 + 7 as feature, i7 as value from train_nonzero
  union all
  select rowid, 16777217 + 8 as feature, i8 as value from train_nonzero
  union all
  select rowid, 16777217 + 9 as feature, i9 as value from train_nonzero
  union all
  select rowid, 16777217 + 10 as feature, i10 as value from train_nonzero
  union all
  select rowid, 16777217 + 11 as feature, i11 as value from train_nonzero
  union all
  select rowid, 16777217 + 12 as feature, i12 as value from train_nonzero
  union all
